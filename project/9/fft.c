...
int main(int argc, int **argv)
{
    ...
    if (rank == 0)
    {
        ...
        computeDuration = totalDuration - comm_Duration;double startTime, endTime, comm_Duration = 0, tmp_duration, totalDuration, computeDuration;
