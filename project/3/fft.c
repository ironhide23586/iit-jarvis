...
int main(int argc, int **argv)
{
    ...
    int memberSizes[2];
    memberSizes[0] = floatSize;
    memberSizes[1] = floatSize;

    MPI_Datatype types[2] = {MPI_INT, MPI_INT};

    MPI_Aint disps[] = {0, floatSize};

    MPI_Type_create_struct(2, memberSizes, disps, types, &mpi_complex);
    ...
    */
    ...
    if (rank == nprocs - 1)
    {
        ...
        //complex myChunk[lastBlockSize][N_lol];
